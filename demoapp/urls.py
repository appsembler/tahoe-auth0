...
urlpatterns = [
    ...
    url(
        r"^author/(?P<pk>[0-9]+)/update/",
        views.AuthorUpdate.as_view(),
        name="author-update",
    ),
    url(
        r"^author/(?P<pk>[0-9]+)/delete/",
    ...
    url(
        r"^book/(?P<pk>[0-9]+)/update/", views.BookUpdate.as_view(), name="book-update"
    ),
    url(
        r"^book/(?P<pk>[0-9]+)/delete/", views.BookDelete.as_view(), name="book-delete"
    ),
    ...
    url(r"^genre/(?P<pk>[0-9]+)", views.GenreView.as_view(), name="genre-detail"),
